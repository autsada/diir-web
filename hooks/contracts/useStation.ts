...
import StationContractDev from "../../abi/localhost/DiiRStation.json"
import StationContractTest from "../../abi/testnet/DiiRStation.json"

const env = process.env.NEXT_PUBLIC_ENV as "localhost" | "testnet"
const contract = env === "localhost" ? StationContractDev : StationContractTest
